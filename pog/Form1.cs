...
namespace pog
{
    public partial class Football : Form
    {
        ...
        {
            SoundPlayer player = new SoundPlayer(Properties.Resources.whistle);
            player.Play();
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //Draw Ball
           //e.Graphics.DrawEllipse(whitePen, ballX, ballY, 10, 10);
        ...
        private void gameTimer_Tick(object sender, EventArgs e)
        {
            ...
            if (goal1Rec.IntersectsWith(ballRec))
            {
               ...
               player2Score++;
                ...
                SoundPlayer player = new SoundPlayer(Properties.Resources.goal1);
                player.Play();
            ...
            if (player1Score == 3 || player2Score == 3)
            {
                ...
                { 
                    ...
                    SoundPlayer player3 = new SoundPlayer(Properties.Resources.finalblow);
                    player3.Play();
                ...
                else
                {
                    ...
                    SoundPlayer player4 = new SoundPlayer(Properties.Resources.finalblow);
                    player4.Play();
                    goalBox.Visible = false;
                }
            }
        ...
        public void ballmove()
        {
            ...
            ballYSpeed = 8;
            goalBox.Visible = false;     
            SoundPlayer player2 = new SoundPlayer(Properties.Resources.crowd1);
            player2.Play();
        }
